...
def home_page():
    ...
    <div class="metric-card">
        <h3 style="text-align: center; ">Welcome to Hotellingece</h3>
    ...
    <div class="metric-card">
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); ">
            <div style="text-align: center; padding: 1.5rem; margin: 1rem; background-color: #f8fafc; border-radius: 8px;">
                <h4 style="color: #1f2937; margin-bottom: 1rem;">📝 1. Create Booking</h4>
                <p style="color: #6b7280;">Add new bookings with guest details, dates, and preferences</p>
            </div>
            <div style="text-align: center; padding: 1.5rem; margin: 1rem; background-color: #f8fafc; border-radius: 8px;">
                <h4 style="color: #1f2937; margin-bottom: 1rem;">🤖 2. AI Prediction</h4>
                <p style="color: #6b7280;">Our AI analyzes patterns to predict cancellation likelihood</p>
            </div>
            <div style="text-align: center; padding: 1.5rem; margin: 1rem; background-color: #f8fafc; border-radius: 8px;">
                <h4 style="color: #1f2937; margin-bottom: 1rem;">📊 3. Monitor & Manage</h4>
